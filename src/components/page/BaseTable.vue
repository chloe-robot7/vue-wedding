    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 宾客名单
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="uid"  label="对应新人编号" width="150" align="center"></el-table-column>
                <el-table-column prop="peopleNumber" align="center" label="赴宴人数"></el-table-column>
                <el-table-column prop="gName" align="center" label="姓名"></el-table-column>
                <el-table-column prop="gPhone" label="手机号" width="240" align="center"></el-table-column>
                <el-table-column prop="blessing" label="祝福语" align="center"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="祝福语">
                    <el-input v-model="form.blessing"></el-input>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        postEdit(){
            ...
            axios.post(`http://114.55.37.219:8081/admin/login/update`,{
                id: this.form.id,
                gName: this.form.gName,
                peopleNumber: this.form.peopleNumber,
                gPhone: this.form.gPhone,
                blessing: this.form.blessing
            }).then(res => {
                this.getData();
            }).catch(function (error)
            {
